...
/**
 * @file plugins/generic/ojsbrFilenameRename/tests/run.php
 *
...
define('OJSBRFILENAMERENAME_STANDALONE_TESTS', true);
...
foreach ($files as $file) {
    require_once $file;
    $class = 'APP\\plugins\\generic\\ojsbrFilenameRename\\tests\\' . basename($file, '.php');
